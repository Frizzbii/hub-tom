    ...
    <nav className="flex items-center justify-between p-4 border-b border-slate-800 bg-black text-white">
        ...
        <div className="flex items-center gap-4">
            <Show when="signed-out">
                <SignInButton>
                    <button className="bg-gradient-to-r from-emerald-600 to-emerald-400 text-white rounded-full font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 cursor-pointer">
                        Sign In
                    </button>
                </SignInButton>
                <SignUpButton>
